...
namespace eastl
{
	...
	class [[deprecated]] generic_iterator
	{
	protected:
		Iterator mIterator;
	...
	struct [[deprecated]] is_generic_iterator : public false_type { };

	template <typename Iterator, typename Container>
	struct [[deprecated]] is_generic_iterator<generic_iterator<Iterator, Container> > : public true_type { };
	...
	///
	template <typename Iterator>
	[[deprecated]] inline typename eastl::is_iterator_wrapper_helper<Iterator, eastl::is_generic_iterator<Iterator>::value>::iterator_type unwrap_generic_iterator(Iterator it)
	{
